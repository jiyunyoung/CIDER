...
L=48  # Codeword length
M=32  # Number of parity checks (k = L - M = 16 info symbols, B = 16*6 = 96 bits)
D_V=2 # Variable node degree
D_C=3 # Check node degree (constraint: L*d_v = M*d_c → 48*2 = 32*3 = 96)
...
K="${ARGS[2]:-2}"     # Number of active users
...
OUTPUT_DIR="${HOME}/data/demix/large_LDPC"
