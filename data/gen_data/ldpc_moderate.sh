...
L=24  # Codeword length
M=16  # Number of parity checks (k = L - M = 8 info symbols)
D_V=2 # Variable node degree
D_C=3 # Check node degree (constraint: L*d_v = M*d_c → 24*2 = 16*3 = 48)
...
OUTPUT_DIR="${HOME}/data/demix/moderate_LDPC"
